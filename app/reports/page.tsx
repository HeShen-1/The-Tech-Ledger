    ...
    <>
      ...
      <main className="mx-auto max-w-screen-xl px-4 py-28">
        ...
        <p className="mb-12 max-w-xl font-body text-base leading-relaxed text-[#525252]">
          Daily snapshots of trending signals. Click a marked date to view the report. Weekly and monthly digests aggregate the top stories.
        </p>
        ...
        <div className="mb-12 grid gap-4 sm:grid-cols-3">
          ...
          >
            <Calendar className="mb-3 h-6 w-6 text-[#CC0000]" strokeWidth={1.5} />
            <h3 className="font-serif text-lg font-black text-[#111111]">Today&apos;s Report</h3>
            <p className="mt-1 font-mono text-[10px] uppercase text-[#737373]">{hasToday ? today : "Not yet generated"}</p>
          </Link>
          <Link
          ...
          >
            <ArrowRight className="mb-3 h-6 w-6 text-[#111111]" strokeWidth={1.5} />
            <h3 className="font-serif text-lg font-black text-[#111111]">Weekly Digest</h3>
            <p className="mt-1 font-mono text-[10px] uppercase text-[#737373]">{weekLabel}</p>
          </Link>
          <Link
          ...
          >
            <ArrowRight className="mb-3 h-6 w-6 text-[#111111]" strokeWidth={1.5} />
            <h3 className="font-serif text-lg font-black text-[#111111]">Monthly Digest</h3>
            <p className="mt-1 font-mono text-[10px] uppercase text-[#737373]">{monthLabel}</p>
          </Link>
        </div>

        {/* Calendar */}
        <ReportCalendar year={now.getFullYear()} month={now.getMonth()} dates={dates} />

        {dates.length === 0 && (
          <p className="mt-4 font-body text-sm italic text-[#737373]">
            No stored snapshots yet. Reports are generated daily. Showing today&apos;s live data below.
          </p>
        )}
